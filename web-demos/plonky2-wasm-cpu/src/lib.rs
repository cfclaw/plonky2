    ...
    C::Hasher: AlgebraicHasher<F>,
{
    ...
    fn prove(
        ...
        let mut timing = TimingTree::new("prove dummy psy type c (CPU/WASM)", Level::Debug);
    ...
    C::Hasher: AlgebraicHasher<F>,
{
    ...
    fn prove(
        ...
        let mut timing = TimingTree::new("prove recursive (CPU/WASM)", Level::Trace);
        let proof = prove::<F, C, D>(
            &self.circuit_data.prover_only,
            &self.circuit_data.common,
            pw,
...
fn run_benchmark_inner() -> Result<BenchmarkResult, String> {
    ...
    // Verify a few more times to get stable timing
    for _ in 0..9 {
...
#[wasm_bindgen]
pub fn run_cpu_benchmark() -> JsValue {
